namespace BilleteraDigital_Web.Models
{
    public class PresupuestoViewModel
    {
        ...
        public List<PresupuestoItemDto> ListaPresupuestos { get; set; }
            = new List<PresupuestoItemDto>();
    }
    ...
    public class PresupuestoItemDto
    {
        ...
        public decimal Disponible =>
            MontoLimite - MontoGastado;

        public double PorcentajeUtilizado =>
            MontoLimite > 0
                ? (double)(MontoGastado / MontoLimite) * 100
                : 0;
        ...
        public string MesAnio =>
            FechaInicio.ToString("MMMM yyyy");
    }
}